...
const squareList = arr => {
    ...
    const newArr = arr
        .filter((num) => num > 0 && num % parseInt(num) === 0) // filtrando los nros positivos y enteros. parseInt convierte al decimal en entero entonces la % no dará 0;
        .map((num) => Math.pow(num, 2)); //multiplico los nros al cuadrado
